...
This code isn't anything you'd use straight out of the box, but this is a fairly common problem:
...
I implemented this in Ruby originally, then decided it might be a good project for trying out Lisp with.
